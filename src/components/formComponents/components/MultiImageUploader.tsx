...
import { ImageFileUploaderType, MultiImageFileUploaderType } from "../types/input.types";
...
const ImapeUploader = ({
  ...
  return (
      <div className="flex flex-col justify-start items-start gap-2 w-full m-4 min-h-[150px]">
        ...
        >
          {value ? <img src={typeof value === "string" ? value : URL.createObjectURL(value[0])} alt="check" className="max-h-[150px]"/> :
