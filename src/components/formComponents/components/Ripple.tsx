...
const RippleButton: React.FC<RippleButtonProps> = ({ children, onClick, btnClass, rippleBackground }) => {
  ...
  const createRipple = (event: MouseEvent<HTMLButtonElement>) => {
    ...
    circle.style.background = rippleBackground! ? rippleBackground : "rgba(200,200,200,0.8)";
