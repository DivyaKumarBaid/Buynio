...
export const productCommonSettings = {
  ...
  inputs: [
    ...
    },
    {
      ...
      header: "Top Left Corner Radius",
      subHeading: "Corner radius for the top-left corner",
      tag: "Corner Radius",
      preText: "",
      postText: "%",
      valueTransformer: (value: string) => value,
    ...
    },
    {
      ...
      header: "Top Right Corner Radius",
      subHeading: "Corner radius for the top-right corner",
      tag: "Corner Radius",
      preText: "",
      postText: "%",
      valueTransformer: (value: string) => value,
    ...
    },
    {
      ...
      subHeading: "Corner radius for the bottom-left corner",
      tag: "Corner Radius",
      preText: "",
      postText: "%",
      valueTransformer: (value: string) => value,
    ...
    },
    {
      ...
      subHeading: "Corner radius for the bottom-right corner",
      tag: "Corner Radius",
      preText: "",
      postText: "px",
      valueTransformer: (value: string) => value,
