            ...
            <>
              ...
              <ModalBody>
                {addSectionOptions.map((section, index) => {
                  return (
                    <div
                      className="border-[1px] border-[var(--card-border-color)] rounded-md hover:border-[var(--card-focus-color)] duration-200 flex flex-col text-[var(--text-secondary-color)] hover:text-[var(--text-primary-color)] break-keep p-4 gap-2 w-max max-w-[200px] cursor-pointer"
